...
import com.example.Stream.entity.db.Item;
import com.example.Stream.entity.db.ItemType;
import com.example.Stream.entity.response.Game;
...
public class GameService {
    ...
    /*
        controller->topGame/searchGame-> buildURL -> searchTwitch -> getGameList
            Gets the request from controller,
            whether is exact search or get top games,
            build the url required,
            search in twitch api,
            twitch returns a json data,
            in getGameList convert the json data into Game object
            using ObjectMapper.



     */
    private static final String TOKEN = "Bearer jni9yn83ehm6wrjekadth4ufgx3cz9";
    private static final String CLIENT_ID = "7wu2esmlq2p9srw98lhdbaq59an1dv";
